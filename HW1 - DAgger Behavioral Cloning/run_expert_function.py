...
*** TODO
 ...
 - Merge run_expert functions by adding a with_rollout boolean
...
def run_expert_with_rollouts(envname, num_rollouts=20, render=True, max_timesteps=1000, export_path='./expert_data', expert_policy_path='./experts/'):
    ...
    with tf.Session():
        ...
        expert_data = {'observations': np.array(rollout_observations),
